...
public class MainActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(this)
                .setMessage(getString(R.string.back_press_text))
                .setCancelable(false)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main_layout) {
            fragmentManager.beginTransaction().replace(R.id.content_frame, new MainFragment()).commit();
        } else if (id == R.id.nav_nisab_layout) {
            fragmentManager.beginTransaction().replace(R.id.content_frame, new NisabFragment()).commit();
        } else if (id == R.id.nav_classes_layout) {
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ClassesFragment()).commit();
        } else if (id == R.id.nav_third_layout) {
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ParentsFragment()).commit();
